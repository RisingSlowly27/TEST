...
INSERT INTO `userinfo` (`userID`, `fullName`, `age`, `course`, `gender`, `contact`) VALUES
(1, 'Don Aloysius', 20, 'B Tech in Computer Science & Technology', 1, 'daafa abadjkadb adb adb adbkbna badbnalb admbd ab adbadba vaadb fnsfnbad adbab'),
(16, 'Tasty Testy', 21, 'Testing Life', 1, 'dfdSahjc acd vfvjavcacukasc ajafvjwhfj acajbvkjabkcasf');
...
--
ALTER TABLE `chats`
  MODIFY `Sl` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `newcon`
--
ALTER TABLE `newcon`
  MODIFY `Sl` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
