...
<body>
    ...
    <div class="Page">
        <div class="leftSide">
            ...
            <div class="sidebar Student activerole" id="stbar">
                ...
                <h2 onclick="selectTab('Bookmarks', this)">BOOKMARKS/SAVED</h2>
                <h2 onclick="selectTab('Downloads', this)">DOWNLOADS</h2>
            ...
            <div class="sidebar Teacher" id="techbar">
                ...
                <h2 id="courseBTN" onclick="selectTab('course', this)">YOUR COURSES</h2>
                <h2 onclick="selectTab('exams', this)">MANAGE EXAMS</h2>
                <h2 onclick="selectTab('discussions', this)">DISCUSSIONS</h2>
                <h2 onclick="selectTab('DownloadsT', this)">DOWNLOADS/BOOKMARKS</h2>
        ...
        <div class="Teacher">
            ...
            <div id="exams" class="tab">
                <div class="explore">
                    ...
                    <input type="text" id="searchT3" class="search" name="toSearch" placeholder="Search For The Course" size="50px">
                    </h1>
                </div>
                <div class="mtestBox">
                <?php
                        ...
                        while (mysqli_num_rows($result) > $count) {
                            ...
                            $HTMLt = "<div class='testmetrics'>
                                            ...
                                            <div class='testDetails'>
                                                <p>$des</p>
                                                Time Limit : $TL<br><br>
                                                <button id='ET$id' class='moveToTest'> Edit Test Settings</button><br>
                                                <button id='AQ$id' class='moveToTest'> Add/Edit Questions</button>
                                            </div>
                                        </div>";
                            echo $HTMLt;
                            $count++;
    ...
    <script>
        ...
        document.getElementById('courseBTN').addEventListener('click',()=>showCourses());
