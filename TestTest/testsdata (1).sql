...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2025 at 11:24 AM
...
(7, 'Testing Test', 0, '', 'fvfvdfvfvfd', '16', '00:10:01', 45, '10', '0000-00-00 00:00:00', '', 1),
(8, 'DSA', 0, '', 'dkjasbdjbdjasbdkjabdkj', '16', '00:00:30', 20, '10', '0000-00-00 00:00:00', '', 1),
...
--
ALTER TABLE `courses`
  MODIFY `Sl` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
...
--
ALTER TABLE `questions`
  MODIFY `qID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;
...
--
ALTER TABLE `topics`
  MODIFY `Topic_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
COMMIT;
