        ...
        <div class="Student activerole">
            ...
            <div id="UpcomingTests" class="tab">
                ...
                <?php
                    ...
                    $sql1="SELECT * FROM `testmap` WHERE `userID` = '$userid'";
                    ...
                    if (mysqli_num_rows($result)>0){
                        ...
                        while (mysqli_num_rows($result) > $count) {
                            ...
                            $id=$rowT['testID'];
                            $sql2="SELECT * FROM `tests` WHERE `test_id` = '$id'";
    ...
    <script>
        ...
        document.addEventListener('click', (event) => {
            if (event.target && event.target.id === 'submitTopic') {
                ...
                formData.append("type", selectedO.value);
        ...
        document.addEventListener('click',(event)=>{
            if (event.target.id=='newConM'){
                ...
                .then(response => response.text())  
                .then(data => {
                    document.getElementById('chatRight').innerHTML = data+"<div><input type='text' id='sendMi'><button id='sendMb'>Send Message</button></div>";  
                })
                .catch(error => console.error("Error:", error));
